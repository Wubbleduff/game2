...
#include "platform_win32/shaders/code_gen/d3d11_vshader_fsq_downsample.h"
#include "platform_win32/shaders/code_gen/d3d11_pshader_fsq_downsample.h"

#include "platform_win32/shaders/code_gen/d3d11_vshader_fsq_upsample.h"
#include "platform_win32/shaders/code_gen/d3d11_pshader_fsq_upsample.h"
...
const void* VERTEX_SHADER_BYTE_CODE[] = {
    ...
    D3D11_VSHADER_fsq,
    D3D11_VSHADER_fsq_downsample,
    D3D11_VSHADER_fsq_upsample,
...
const size_t VERTEX_SHADER_BYTE_CODE_SIZE[] = {
    ...
    sizeof(D3D11_VSHADER_fsq_downsample),
    sizeof(D3D11_VSHADER_fsq_upsample),
...
const void* PIXEL_SHADER_BYTE_CODE[] = {
    ...
    D3D11_PSHADER_fsq,
    D3D11_PSHADER_fsq_downsample,
    D3D11_PSHADER_fsq_upsample,
...
const size_t PIXEL_SHADER_BYTE_CODE_SIZE[] = {
    ...
    sizeof(D3D11_PSHADER_fsq_downsample),
    sizeof(D3D11_PSHADER_fsq_upsample),
